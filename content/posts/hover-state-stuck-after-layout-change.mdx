...
<img src="/assets/images/hover-state-stuck-after-layout-change-image-1.gif" alt="demo" />
...
<FlowDiagram
  height={320}
  caption="레이아웃이 바뀐 뒤 재판정이 실행되는 경로와 굳는 경로"
  nodes={[
    { id: "change", title: "레이아웃 변경", description: "히트 테스트 경계가 이동", x: 0, y: 110, kind: "accent" },
    { id: "queue", title: "재판정 예약", description: "다음 프레임으로 미룸", x: 240, y: 110 },
    { id: "frame", title: "계기가 옴", description: "전환, rAF, 입력, 레이아웃 강제", x: 500, y: 0 },
    { id: "idle", title: "계기가 없음", description: "페이지가 조용해짐", x: 500, y: 220 },
    { id: "clear", title: "hover 풀림", x: 830, y: 0, kind: "accent" },
    { id: "stuck", title: "hover 굳음", x: 830, y: 220 },
  ]}
  edges={[
    { from: "change", to: "queue" },
    { from: "queue", to: "frame" },
    { from: "queue", to: "idle" },
    { from: "frame", to: "clear", label: "재판정 실행", animated: true },
    { from: "idle", to: "stuck", label: "영영 대기" },
  ]}
/>
